<?php
    ...
    class ArticleController extends Controller {
        ...
        public function new(Request $request) {
            ...
            ->add('save', SubmitType::class, array('label' => 'Create', 'attr' => array('class' => 'btn btn-primery mt-3')))
            ->getForm();
        ...
        public function edit(Request $request, $id) {
            ...
            ->add('title', TextType::class, array('attr' => array('class' => 'form-control')))
            ->add('body', TextareaType::class, array('required' => false, 'attr' => array('class' => 'form-control')))
            ->add('save', SubmitType::class, array('label' => 'Update', 'attr' => array('class' => 'btn btn-primery mt-3')))
            ->getForm();
        ...
        public function save() {
            ...
            return new Response('Saves an article with an id = ' . $article->getId() );
        }
    */
